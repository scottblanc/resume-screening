...
2. **Choose and configure your AI model**:
   ...
   **Groq**
   ...
   - Set environment variable: `export GROQ_API_KEY="your_groq_api_key_here"`
   ...
   **Anthropic Claude**
   ...
   - Set environment variable: `export ANTHROPIC_API_KEY="your_anthropic_api_key_here"`
...
### Experience
- `estimated_job_level`: Job level (Intern, L3/AMTS, L4/MTS, L5/SMTS, L6/LMTS, L7/PMTS, L8/Architect)
